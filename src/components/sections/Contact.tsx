        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <dl className="mt-4 space-y-3 text-white/90">
              ...
              <div className="flex items-center gap-3 text-white/40">
                ...
                <dd>Office Address — coming soon</dd>
              </div>
              <div className="flex items-center gap-3 text-white/40">
                <dd>Email — coming soon</dd>
              </div>
            </dl>
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-white/50">
              <p className="text-sm font-semibold uppercase tracking-wide text-amber-400">Find Us</p>
              <p className="mt-3 text-sm">Google Maps embed — coming soon.</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-white/50">
              <p className="text-sm font-semibold uppercase tracking-wide text-amber-400">Follow Us</p>
              <p className="mt-3 text-sm">Instagram &amp; Facebook links — coming soon.</p>
            </div>
          </div>
        </div>
      </div>
